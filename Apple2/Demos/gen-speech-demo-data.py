...
print()
emit("introData", INTRO, '"Hello. I am the Mockingboard speech chip."')
emit("sarahData", SARAH, "the recurring interjection between sections")
emit("voiceData", VOICE, '"This is my voice." -- spoken at three filter settings')
emit("wargData", wargames(), '"Shall we play a game?" -- declination, dip, then a drawn rise')
emit("halData", HAL, '"I\'m sorry Dave. I\'m afraid I can\'t do that." -- slow and level')
