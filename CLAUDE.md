...
**In flight elsewhere: `specs/024-mockingboard-speech`** — the SSI-263 voice
chip, and a sound-only / sound+speech card variant split (GH #123). Lives on
branch `024-mockingboard-speech`; its spec is on that branch, not master.
