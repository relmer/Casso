...
class CassqueOptionsPanel : public DxuiPanel
{
public:
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassqueOptionsDialog
//
//  Cassque's settings: today, the form a copy out of an image takes on the
//  host. OK keeps the choices; Cancel, Escape and the close box leave them.
//
////////////////////////////////////////////////////////////////////////////////

class CassqueOptionsDialog : public DxuiDialogWindow
{
public:
    struct Choices
    {
...
private:
    ...
    CassqueOptionsPanel  * m_body      = nullptr;
};
