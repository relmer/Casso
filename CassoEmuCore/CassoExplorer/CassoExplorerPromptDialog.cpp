...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptPanel::Init
//
////////////////////////////////////////////////////////////////////////////////

void CassoExplorerPromptPanel::Init (DxuiLabel & label, DxuiTextInput & input)
{
    m_label = &label;
    m_input = &input;
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptPanel::Layout
//
////////////////////////////////////////////////////////////////////////////////

void CassoExplorerPromptPanel::Layout (const RECT & boundsDip, const DxuiDpiScaler & scaler)
{
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptPanel::OnMouse
//
////////////////////////////////////////////////////////////////////////////////

bool CassoExplorerPromptPanel::OnMouse (const DxuiMouseEvent & ev)
{
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptDialog::Configure
//
////////////////////////////////////////////////////////////////////////////////

void CassoExplorerPromptDialog::Configure (const std::wstring & label, const std::wstring & initialText, const IDxuiTheme * theme, size_t maxLength)
{
    m_labelText = label;
    m_text      = initialText;
    m_theme     = theme;
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptDialog::OnCreate
//
//  OK keeps its own click so the text is read before the dialog ends.
//
////////////////////////////////////////////////////////////////////////////////

void CassoExplorerPromptDialog::OnCreate()
{
    ...
    m_body = CreateDialogContent<CassoExplorerPromptPanel>();
...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptDialog::Ask
//
////////////////////////////////////////////////////////////////////////////////

bool CassoExplorerPromptDialog::Ask (HWND                  owner,
...
{
    HRESULT                    hr     = S_OK;
    CassoExplorerPromptDialog  dialog;
