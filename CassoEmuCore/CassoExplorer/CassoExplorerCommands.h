...
public:
    ...
    CassoExplorerCommands (const CassoExplorerCommands &)             = delete;
    CassoExplorerCommands & operator= (const CassoExplorerCommands &) = delete;
...
private:
    ...
    static constexpr Row  kRows[] =
    {
        ...
        { kAbout,             Menu::Help, L"&About Casso Explorer...",   L"F1",       false },
    };
