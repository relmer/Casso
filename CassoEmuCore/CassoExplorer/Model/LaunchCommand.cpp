...
////////////////////////////////////////////////////////////////////////////////
//
//  LaunchCommand::MakeCassoExplorerArguments
//
////////////////////////////////////////////////////////////////////////////////

std::wstring LaunchCommand::MakeCassoExplorerArguments (HWND owner, const std::wstring & titlePrefix)
{
...
{
    return L"Casso Explorer is not installed\n"
...
////////////////////////////////////////////////////////////////////////////////
//
//  LaunchCommand::LaunchCassoExplorer
//
////////////////////////////////////////////////////////////////////////////////

LaunchCommand::Outcome LaunchCommand::LaunchCassoExplorer (
    IProcessLauncher    & launcher,
    const std::wstring  & moduleDirectory,
    HWND                  owner,
    const std::wstring  & titlePrefix)
{
    std::wstring  exePath = GetSiblingPath (moduleDirectory, kCassoExplorerExe);
    HRESULT       hr      = S_OK;
    ...
    hr = launcher.Launch (exePath, MakeCassoExplorerArguments (owner, titlePrefix));
