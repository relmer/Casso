...
////////////////////////////////////////////////////////////////////////////////
//
//  CassoExplorerPromptPanel
//
//  A label over a single-line text field, filling the dialog's content area.
//
////////////////////////////////////////////////////////////////////////////////

class CassoExplorerPromptPanel : public DxuiPanel
{
public:
...
class CassoExplorerPromptDialog : public DxuiDialogWindow
{
public:
...
private:
    ...
    CassoExplorerPromptPanel  * m_body      = nullptr;
};
