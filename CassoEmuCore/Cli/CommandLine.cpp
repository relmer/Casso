...
static const char *  s_kDebugOptionLines[] =
{
    ...
    "  {0}mode <mode>{1}          The starting command mode: applewin (default), monitor, or gssquared",
    "  {0}output <format>{1}      The starting output format, applewin, monitor, or gssquared; default: the mode's own",
