...
- [ ] T029 Parity walkthrough (SC-003): scripted checklist over every interaction in contracts/scene-interaction.md, windowed + fullscreen; record results in the PR; gestalt sign-off vs reference photos (SC-006)
