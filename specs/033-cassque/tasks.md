...
- [ ] T125 [US5] Measure File Explorer's tabs at 100% and 200%: shape, full and minimum width, icon, label inset, close button, + button, and the selected tab joining the row below; record in `research.md`
