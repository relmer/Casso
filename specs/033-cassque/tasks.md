...
- [ ] T127 [US1] Tab icons and labels from the location: the folder's or drive's shell icon and display name, an image's icon and name (FR-048)
...
- [ ] T104 [US2] `AppleSingleCodec` in CassoEmuCore: read and write the container (data fork, real name, ProDOS type and aux type, dates), with no knowledge of memory or disks; round-trip and malformed-header tests. Shared with 035-debugger (research R-016): whichever spec implements first builds it, and tells the other
