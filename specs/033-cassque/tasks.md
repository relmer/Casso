...
- [x] T113 [US1] Sort and View dropdowns over the list, the view choice persisted through `CassquePrefs`; Preview toggle and Theme dropdown at the bar's trailing end (FR-043, FR-044, FR-027)
