...
- **SC-018**: After Phase 11, `Casso/EmulatorShell.cpp` shrinks by **≥ 40 %** from its current 4,170 lines (target: ≤ 2,502 lines).
...
- **SC-020**: After Phase 11, the NC plumbing duplicate count equals 2 (`SettingsWindow`, `DialogPrimitive`); after Phase 14 it equals 1 (`DxuiHostWindow` only), satisfying the original SC-010 invariant.
