...
Four divergences, all measured against Merlin Pro 2.23 rather than argued. Each
one is source real Merlin assembles and Casso does not reproduce, which SC-003
defines as a defect rather than a limitation.

The bytes for all four are **already committed**, in the pending table in
