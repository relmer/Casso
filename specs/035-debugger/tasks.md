...
- [ ] T104 [US4] Measure SC-009 with the pinned procedure (`start /wait /b /high /affinity 10`, 10 or more runs, round-robin arms): window open with the trace off versus closed. Record the numbers in the commit message; if the difference exceeds 3% (SC-009), find the cost before continuing.
