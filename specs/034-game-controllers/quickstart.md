...
| 4 | With only the Xbox controller attached, hold the stick right and A, then unplug. | Within 100 ms both paddles center and both buttons release; the notice says nothing drives the axes; the arrow keys do not move the paddles and X/Z still type. | FR-010, FR-008a, FR-013, SC-005 |
...
| 11 | Choose a controller from the command bar's paddle-source picker, and a profile once profiles exist; with the picker open, click a menu title; plug a controller in while the Machine menu is open. | Selection and profile change without opening Settings, without a reset. | FR-008, FR-028, FR-031, SC-010 |
...
| 13 | With those two assigned, unplug one. | Only its axis centers; the other keeps reading its own stick with no interruption, and the controller still driving does not move to the unplugged one's axis. | SC-012, FR-008a, FR-010 |
