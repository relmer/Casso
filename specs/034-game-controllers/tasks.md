...
- [ ] T056 [P] [US3] Extend `UnitTest/ControllerTests/PaddleSourceRowsTests.cpp`: the picker's label and tooltip for connected, not connected, and another controller standing in (T059 settles whether the glyph also changes). The cluster this task named is gone (T051).
