...
- **Print Job**: The machine's single open strip — all rendered output since the last successful eject, with its page boundaries. Awaiting or undergoing delivery to the selected destination; survives guest resets and emulator restarts until delivered or discarded.
