...
// Embedded 3D models for the desk scene (generated by scripts/modelgen/,
// same OBJ+MTL dialect). See Resources/Models/.
// Paired by machine: the //e and ][+ wear the beige Monitor II over Disk II
// drives, the //c the platinum Monitor //c over its matching 5.25 drives.
// Mixing the two families is the thing that reads wrong -- a //c monitor
// over //e drives is two different eras of Apple industrial design stacked.
#define IDR_MODEL_MONITOR2C_OBJ             402
#define IDR_MODEL_MONITOR2C_MTL             403
#define IDR_MODEL_DISKII_OBJ                404
#define IDR_MODEL_DISKII_MTL                405
#define IDR_MODEL_MONITOR2_OBJ              406
#define IDR_MODEL_MONITOR2_MTL              407
#define IDR_MODEL_DISK2C_OBJ                408
#define IDR_MODEL_DISK2C_MTL                409
#define IDR_MODEL_DUODISK_OBJ               410
#define IDR_MODEL_DUODISK_MTL               411
