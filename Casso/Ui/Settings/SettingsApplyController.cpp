...
void SettingsApplyController::SettingsApplyAdapter::ApplySpeedMode (SettingsSpeedMode mode)
{
...
void SettingsApplyController::SettingsApplyAdapter::ApplyColorMode (SettingsColorMode mode)
{
...
void SettingsApplyController::SettingsApplyAdapter::ApplyFloppySound (bool enabled)
{
...
void SettingsApplyController::SettingsApplyAdapter::ApplyMechanism (const std::string & mechanism)
{
    m_shell.PostCommand (IDM_AUDIO_DRIVE_MECHANISM, mechanism);
}


void SettingsApplyController::SettingsApplyAdapter::ApplyDriveVolumes (float motor, float head, float door)
{
    char  payload[32] = {};
...
void SettingsApplyController::SettingsApplyAdapter::ApplyDrivePan (float driveOnePan, float driveTwoPan)
{
    char  payload[32] = {};
...
void SettingsApplyController::SettingsApplyAdapter::ApplyWriteProtect (int drive, bool wp)
{
...
void SettingsApplyController::SettingsApplyAdapter::ApplyExternalDriveConnected (bool connected)
{
...
void SettingsApplyController::SettingsApplyAdapter::ApplyMouseConnected (bool connected)
{
