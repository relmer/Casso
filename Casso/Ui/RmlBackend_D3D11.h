...
public:
    ...
    // Exposed for the smoke tests in UnitTest/UiTests/RmlBackendSmokeTests.cpp.
...
private:
    ...
    static HRESULT LoadImageBytesViaWic (const std::vector<Byte>  & bytes,
                                         std::vector<Byte>        & outRgbaPremultiplied,
                                         UINT                     & outWidth,
                                         UINT                     & outHeight);

    static HRESULT CompileHlsl          (const char           * src,
                                         size_t                 srcLen,
                                         const char           * entry,
                                         const char           * profile,
