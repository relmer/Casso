...
struct InputDeviceGlyphs::GlyphMap
{
    float  bx, by, s;
...
void InputDeviceGlyphs::PaintJoystickGlyph (IDxuiPainter & p, const RECT & box, bool skeuo)
{
...
void InputDeviceGlyphs::PaintPaddleGlyph (IDxuiPainter & p, const RECT & box, bool skeuo)
{
    GlyphMap  g (box);
...
void InputDeviceGlyphs::PaintMouseGlyph (IDxuiPainter & p, const RECT & box, bool skeuo)
{
    GlyphMap  g (box);
