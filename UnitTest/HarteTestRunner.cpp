...
namespace HarteTests
{
    ...
    public:
        ...
        // Only $DB is skipped. Harte's corpus (both synertek65c02 and
        // rockwell65c02) models $DB as a 2-byte NOP, but Klaus Dormann's
        ...
        //
        // Choosing between them is legitimate because the corpus is generated by
        // a reference implementation conforming to documentation rather than
        // measured off silicon, so neither oracle is hardware truth here. See
        // IsCycleCountDisputed below, which makes the same call for $5C and $CB.
