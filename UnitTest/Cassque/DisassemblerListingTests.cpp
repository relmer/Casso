...
TEST_CLASS (DisassemblerListingTests)
{
public:
    ...
    static void AssertLines (const std::vector<DisassembledInstruction> & lines,
    ...
    TEST_METHOD (Nmos_EveryAddressingMode)
    {
        ...
        std::vector<DisassembledInstruction>  lines;
