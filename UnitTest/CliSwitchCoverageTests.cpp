    ...
    static std::vector<SwitchCase> Cases()
    {
        return
        {
            ...
            { "as65", "on-change", { "CassoCli", "as65", "p.a65", "--disk", "work.dsk",
                                     "--on-change", "reboot" },
              [] (const CommandLineOptions & o) { return o.changeIntent == ExternalChangeIntent::Restart; },
            ...
            { "merlin", "on-change", { "CassoCli", "merlin", "p.s", "--disk", "work.dsk",
                                       "--on-change", "reload" },
              [] (const CommandLineOptions & o)
              { return o.changeIntent == ExternalChangeIntent::ReloadInPlace; },
              "--on-change specifies what a running Casso does with the modified disk" },
            ...
            { "disk", "on-change", { "CassoCli", "disk", "put", "d.dsk", "p.bin", "--on-change", "reboot" },
              [] (const CommandLineOptions & o)
              { return o.disk.changeIntent == ExternalChangeIntent::Restart; },
