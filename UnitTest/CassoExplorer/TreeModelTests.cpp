...
public:
    ...
    {
        AssertSucceeded (fs.WriteAllText (L"C:\\Disks\\dos33.dsk",    FixtureContent ("CassoExplorer/dos33.dsk")));
        AssertSucceeded (fs.WriteAllText (L"C:\\Disks\\prodos.po",    FixtureContent ("CassoExplorer/prodos.po")));
