...
TEST_CLASS (CassoExplorerFixtureTests)
{
public:

    static constexpr const char *  kDos33Image  = "CassoExplorer/dos33.dsk";
    static constexpr const char *  kProDosImage = "CassoExplorer/prodos.po";
