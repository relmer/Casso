...
public:
    ...
    {
        Seed (io, "CassoExplorer/dos33.dsk",          kCliImage);
        Seed (io, "CassoExplorer/dos33.dsk",          kFacadeImage);
        Seed (io, "CassoExplorer/prodos.po",          kCliProDos);
        Seed (io, "CassoExplorer/prodos.po",          kFacadeProDos);
        Seed (io, "CassoExplorer/Host/notes.txt",     kHostText);
        Seed (io, "CassoExplorer/Host/odd.bin",       kHostBinary);
        Seed (io, "CassoExplorer/Host/applesoft.txt", kHostListing);
    }
