"""Build CassoExplorer's icon and About picture: a cask with a cassowary's casque on it.

Produces:
  Resources/Icons/CassoExplorer.png   - 1024x1024 master PNG
  Resources/Icons/CassoExplorer.ico   - Multi-resolution ICO (16, 24, 32, 48, 64, 128, 256)
  CassoExplorer/Assets/CassoExplorer.png    - 256x256, the picture in CassoExplorer's About box
  CassoExplorer/Assets/CassoExplorerCask.png  - 128x128, the bare cask, for the About box
  CassoExplorer/Assets/CassoExplorerCasso.png - 128x128, Casso's icon, for the About box
...
ABOUT_CASK_PNG = ABOUT_PNG.with_name("CassoExplorerCask.png")
ABOUT_CASSO_PNG = ABOUT_PNG.with_name("CassoExplorerCasso.png")
...
def main() -> None:
    # The About box explains the name as cask + Casso = CassoExplorer, with icons,
